...
export default createGlobalStyle`
  @font-face {
    ...
    font-weight: 300;
    src: local(경기천년제목 Light),
    url(/fonts/MainFontL.eot);
  ...
  @font-face {
    font-family: 'MainFont';
    font-weight: 400;
    src: local(경기천년제목 Medium),
    url(/fonts/MainFontM.eot);
  ...
  @font-face { 
    font-family: 'MainFont';
    font-weight: 700;
    src: local(경기천년제목 Bold),
    url(/fonts/MainFontB.eot);
  ...
  @font-face {
    ...
    font-weight: 900;
    src: local(경기천년제목V Bold),
    url(/fonts/MainFontVB.eot);
